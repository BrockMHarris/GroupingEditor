...
public class SyntaxHighlight extends DefaultStyledDocument {
    private String word = "";
    ...
    public SyntaxHighlight(JTextPane pane) {
        ...
        this.setCommentColor(comment);
        this.setJavadocColor(javadoc);
        this.setAnnotationColor(annotation);

        Color defColor = new Color(127,0,85);
        for(int i=0; i<RESERVEDWORDS.length; i++){
            keywords.put(RESERVEDWORDS[i], defColor);
        }
        this.setKeywords(keywords);
        pane.setDocument(this);
    }
...
//            for(int i = 0; i < RESERVEDWORDS.length; i++){
//                if(st.nextToken().equals(RESERVEDWORDS[i])){
//                    //try { pane.setText(pane.getText() + "BLAH ",style); }
//                    //catch (BadLocationException e){}
//                }
//            }
//        }
//        for(int i = 0; i < RESERVEDWORDS.length; i++){
//            //newText.replaceAll("\\" + RESERVEDWORDS[i] + "\\b", "sword");
//            //StringTokenizer st = new StringTokenizer(text, " ():");
//
//            //try { pane.insertString(doc.getLength(), "BLAH ",style); }
//            //catch (BadLocationException e){}
//        }
//    }
//}
